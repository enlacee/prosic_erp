    ...
    <html lang="es">
        <head>
           ...
           <script src="anb_js/grid.locale-es.js" type="text/javascript"></script>
            ...
            <!--EMPRESA -->
            <script src="sunat_planilla/view-empresa/js/misgrid.js" type="text/javascript"></script>
            <!-- -->
            
            <!--CONFIGURACION -->
            <script src="sunat_planilla/view-conf/js/misgrid.js" type="text/javascript"></script>
            <!-- -->
