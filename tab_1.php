...
-->	
       ...
       <!--
       // HABILITAR  ANBIBAL .27/09/2012
            
            <span class="foldertreeview">Empleador</span><br/>                      
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-plame/view_empleador_2.php','#CapaContenedorFormulario')">
                    Modificar 2
                </a>
            </span>
            <br />            
            ...
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-empresa/view_declaracion_registrada.php','#CapaContenedorFormulario')">
        ...
        <h3 class="text_blanco" style="color:#FFFFFF">EMPRESA</h3>
        <p>
          <span class="foldertreeview">Periodos</span><br/>						
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-empresa/view_periodo.php','#CapaContenedorFormulario')">
                    Periodos
                </a>
            </span>
            <br />
            ...
            <!-- <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-empresa/view_registro_por_concepto.php','#CapaContenedorFormulario')">
            ...
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-empresa/view_registro_concepto_e.php','#CapaContenedorFormulario')">
                    Conceptos Emp.               </a>            </span>
            <br />
            
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-empresa/view_pvacaciones.php','#CapaContenedorFormulario')">
                    planilla Vacaciones
                </a>
            </span>
            <br /> 
   ...
   <!--         
          <span class="foldertreeview">PDT-PlAME Estructuras</span><br/>						
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-empresa/estructuras/index.php','#CapaContenedorFormulario')">
                    Exportar Archivos
                </a>
            </span>
            <br />              
            ...
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-empresa/view_declaracion.php','#CapaContenedorFormulario')">
                    Declaraciones R
                </a>
            </span>
            <br />  
-->
        ...
        <h3 class="text_blanco" style="color:#FFFFFF">CONFIGURACION</h3>
        <p>
            <!--<span class="foldertreeview">Empresa</span><br/>						
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-plame/view_empleador.php','#CapaContenedorFormulario')">
                    nueva Empresa
                </a>
            ...
            <span class="foldertreeview">Conf-Planilla</span><br/>						
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-conf/view_uit.php','#CapaContenedorFormulario')">
                    UIT
                </a>
            </span>
            <br />
            ...
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-conf/view_sueldbasico.php','#CapaContenedorFormulario')">
                    Sueldo Basico
                </a>
            </span>						
            <br />
            ...
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-conf/view_asignacionfamiliar.php','#CapaContenedorFormulario')">
                    Asignacion Familiar
                </a>
            </span>						
            <br />
            ...
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-conf/view_onp.php','#CapaContenedorFormulario')">
                    ONP
                </a>
            </span>						
            <br />
           <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-conf/view_afp.php','#CapaContenedorFormulario')">
                    AFP
                </a>
            </span>						
            <br />            
           ...
           <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-conf/view_topeafp.php','#CapaContenedorFormulario')">
                    Tope AFP
                </a>
            </span>						
            <br />            
            ...
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-conf/view_essalud.php','#CapaContenedorFormulario')">
                    ESSALUD
                </a>
            </span>						
            <br />
...
<!--
            <span class="foldertreeview">Conf-Formulas</span><br/>						
            <span class="icn1">
                <a class="linka1" href="javascript:cargar_pagina('sunat_planilla/view-conf/view_formulas.php','#CapaContenedorFormulario')">
                    Formulas
                </a>
            </span>
            <br /> 
