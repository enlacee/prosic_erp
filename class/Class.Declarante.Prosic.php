...
class Declarante_Prosic extends Mysql_Prosic {
	
	    function CargarDataDeclarante($where, $short, $limit) {
        $sql = "SELECT
			    plr0010000.plr0010001
			    , plr0010000.plr0010002
				, tab0030000.tab0030001
				, tab0030000.tab0030002
				FROM
				dbprosic.plr0010000
				INNER JOIN dbprosic.tab0030000 
					ON (plr0010000.plr0010001 = tab0030000.tab0030001) $where $short $limit;";
        $res = $this->Consulta_Mysql($sql);
        return $res;
    }
	
	function ConsultaDeclaranteId($id){
