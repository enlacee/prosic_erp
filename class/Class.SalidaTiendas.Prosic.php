...
class Salida_Prosic extends Mysql_Prosic {
    ...
    function cargar_data_registro_salida($idlocal, $codigo='', $descripcion='', $documento='', $proveedor='', $limit='') {
   if($idlocal == '1'){
   $tabla = 'alm2012010';
   }
   if($idlocal == '2'){
   ...
   $sql = "SELECT alm0010006
	...
	//add 24-04
	    function getdataSalida($tabla, $codigo='', $descripcion='', $documento='', $proveedor='', $limit='') {
