...
class CajaCajero_Prosic extends Mysql_Prosic {
    ...
    function select_status_cajero($etiqueta, $id, $defecto) {
    ...
    public function get_cajero($nombre_cajero='', $limit='') {
        $sql = "select * from dbprosic_cajasi.prosic_cajero";
        $sql.= " where status_cajero in('AC','DS') ";

        if ($nombre_cajero != '') {
            $sql.=" and  nombre_cajero like'%" . $nombre_cajero . "%' ";
        }
        $sql . " order by nombre_cajero";
        ...
        public function row_cajero($id_cajero) {
        $sql = "select * from dbprosic_cajasi.prosic_cajero ";
        $sql.= " where id_cajero=".$id_cajero;               
        mysql_select_db("dbprosic_cajasi");
        $res = $this->Consulta_Mysql($sql);
